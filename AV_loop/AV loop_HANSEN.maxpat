...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 523.0, 295.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 519.5, 252.0, 77.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 235.0, 270.0, 186.0, 108.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 188.0, 186.0, 108.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 508.0, 345.0, 42.0, 22.0 ],
					"text" : "lores~"
				}
...
, 			{
				"box" : 				{
					"basictuning" : 440,
					"clipheight" : 26.666666666666668,
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "odee.mp3",
								"filename" : "odee.mp3",
								"filekind" : "audiofile",
								"id" : "u010002767",
								"loop" : 0,
...
, 							{
								"absolutepath" : "ManWhoSoldtheWorld.mp3",
								"filename" : "ManWhoSoldtheWorld.mp3",
								"filekind" : "audiofile",
								"id" : "u116003055",
								"loop" : 0,
								"content_state" : 								{
...
, 							{
								"absolutepath" : "likethat.mp3",
								"filename" : "likethat.mp3",
								"filekind" : "audiofile",
								"id" : "u282003457",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 432.0, 121.0, 180.0, 83.0 ],
					"pitchcorrection" : 0,
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 188.0, 160.0, 79.0 ],
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 521.0, 198.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "pannr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 521.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 269.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 365.0, 398.0, 110.0, 54.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 20.0, 224.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "husalir",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 20.0, 369.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "delayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 692.0, 168.0, 108.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 298.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 273.0, 212.0, 110.0, 54.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 16.0, 348.0, 170.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 16.0, 348.0, 170.0 ],
					"prototypename" : "pixl",
					"varname" : "avplayr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-13::obj-14" : [ "umenu[3]", "umenu", 0 ],
			"obj-13::obj-22" : [ "range[7]", "range", 0 ],
			"obj-13::obj-24" : [ "pictctrl[73]", "pictctrl[6]", 0 ],
			"obj-13::obj-30" : [ "pictctrl[71]", "pictctrl[5]", 0 ],
			"obj-13::obj-32" : [ "pictctrl[72]", "pictctrl[7]", 0 ],
			"obj-13::obj-39" : [ "pictctrl[74]", "pictctrl[8]", 0 ],
			"obj-13::obj-41" : [ "pictctrl[70]", "pictctrl[10]", 0 ],
			"obj-13::obj-52::obj-23" : [ "gswitch2[6]", "gswitch2", 0 ],
			"obj-13::obj-94" : [ "umenu[2]", "umenu", 0 ],
			...
			"obj-1::obj-48" : [ "pictctrl[36]", "pictctrl[2]", 0 ],
			...
			"obj-7::obj-11" : [ "pictctrl[10]", "pictctrl[1]", 0 ],
			"obj-7::obj-14" : [ "pictctrl[12]", "pictctrl[1]", 0 ],
			"obj-7::obj-22" : [ "range[5]", "range", 0 ],
			"obj-9::obj-13" : [ "pictctrl[45]", "pictctrl[1]", 0 ],
			"obj-9::obj-3" : [ "range[6]", "range", 0 ],
			"obj-9::obj-37" : [ "Y offset", "Y offset", 0 ],
			"obj-9::obj-41" : [ "pictctrl[44]", "pictctrl[1]", 0 ],
			"obj-9::obj-48" : [ "Bound mode", "Bound mode", 0 ],
			"obj-9::obj-53" : [ "pictctrl[46]", "pictctrl[1]", 0 ],
			"obj-9::obj-56::obj-23" : [ "gswitch2[5]", "gswitch2", 0 ],
			"obj-9::obj-68" : [ "X offset", "X offset", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [ 			{
				"name" : "ManWhoSoldtheWorld.mp3",
				"bootpath" : "~/Desktop/ATLS 4600/AV_loop",
				"patcherrelativepath" : ".",
				"type" : "Mp3",
				"implicit" : 1
			}
